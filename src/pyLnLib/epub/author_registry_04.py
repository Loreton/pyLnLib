...
class AuthorRegistry:
    ...
    # Ricerca
    # ==================================================================
    def _find_surname( self, value: str, ) -> str | None:
    ...
    # ==================================================================
    def _find_surname_in_words( self, words: list[str], ) -> tuple[str, int, int] | None:
        """
    ...
    def _identify( self, value: str, ) -> tuple[str, str] | None:
        ...
        # --------------------------------------------------------------
        if indexes is None:
            self._add("ignore", cleaned) # devo mettere valore originale
            return None
